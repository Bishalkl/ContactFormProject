  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center py-4">
      ...
      <div class="hidden md:flex space-x-4 items-center">
        <a href="#about-us" class="text-gray-600 hover:text-blue-600 transition font-medium">About Us</a>
        <a href="#contact" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition font-medium">Contact Form</a>
      </div>
